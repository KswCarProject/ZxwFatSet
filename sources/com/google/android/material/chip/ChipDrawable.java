...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    public static com.google.android.material.chip.ChipDrawable createFromResource(android.content.Context r4, int r5) {
        ...
        L_0x0012:
            ...
            int r1 = com.google.android.material.R.style.Widget_MaterialComponents_Chip_Entry     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0043 }
        L_0x002c:
            int r2 = com.google.android.material.R.attr.chipStandaloneStyle     // Catch:{ XmlPullParserException -> 0x0045, IOException -> 0x0043 }
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, GyroScopeWithCompassView.CARTYPE_RONGWEIW5_LO));
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(SupportMenu.CATEGORY_MASK, GyroScopeWithCompassView.CARTYPE_RONGWEIW5_LO));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, GyroScopeWithCompassView.CARTYPE_RONGWEIW5_LO));
