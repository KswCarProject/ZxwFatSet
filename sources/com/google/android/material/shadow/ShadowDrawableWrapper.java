...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildShadowCorners() {
        ...
        if (f3 > 0.0f) {
            ...
            int[] iArr = {0, this.shadowStartColor, this.shadowMiddleColor, this.shadowEndColor};
            RadialGradient radialGradient = r8;
            float[] fArr = {0.0f, f4, ((SHADOW_BOTTOM_SCALE - f4) / 2.0f) + f4, 1.0f};
            RadialGradient radialGradient2 = new RadialGradient(0.0f, 0.0f, f3, iArr, fArr, Shader.TileMode.CLAMP);
            paint.setShader(radialGradient);
        }
        Paint paint2 = this.edgeShadowPaint;
        float f5 = rectF.top;
        float f6 = rectF2.top;
        int[] iArr2 = {this.shadowStartColor, this.shadowMiddleColor, this.shadowEndColor};
        paint2.setShader(new LinearGradient(0.0f, f5, 0.0f, f6, iArr2, new float[]{0.0f, SHADOW_HORIZ_SCALE, SHADOW_BOTTOM_SCALE}, Shader.TileMode.CLAMP));
